package ch.aarboard.vamm.views.mailaccount;
...
@PageTitle("Mail Account")
@Route("domain-mail-account")
@Menu(order = 2, icon = LineAwesomeIconUrl.PENCIL_RULER_SOLID)
public class MailAccountView extends Composite<VerticalLayout> {
